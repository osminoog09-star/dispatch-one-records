...
- Сайт `/support` умеет локально проверить `.log/.txt` и добавить краткую диагностику в обращение.
...
- Готов модуль `discord_ticket_bot/`: кнопка создания тикета, приватные каналы, синхронизация комментариев.
...
- Инструкция запуска бота: `discord_ticket_bot/README.md`.
